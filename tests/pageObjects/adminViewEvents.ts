...
export class adminViewEventsPage {
    ...
    constructor(page: Page) {
        ...
        this.noOfPackagesLabel = page.locator("//span[text()='Number of packages ']");
        this.statusLabel = page.locator("//span[text()='Status']");
        this.eventCreateButton = page.locator("//a[@href='/events/create']");
        this.eventNameColumnData = page.locator("//tbody[@class='border-ui-border-base border-b-0']//td[1]");
        this.programNameColumnData = page.locator("//tbody[@class='border-ui-border-base border-b-0']//td[2]");
        this.eventDateColumnData = page.locator("//tbody[@class='border-ui-border-base border-b-0']//td[3]");
        this.departmentColumnData = page.locator("//tbody[@class='border-ui-border-base border-b-0']//td[4]");
        this.groupsColumnData = page.locator("//tbody[@class='border-ui-border-base border-b-0']//td[5]");
        this.noOfPackagesColumnData = page.locator("//tbody[@class='border-ui-border-base border-b-0']//td[6]");
        this.statusColumnData = page.locator("//tbody[@class='border-ui-border-base border-b-0']//td[7]");
