...
export class adminViewProgramsPage {
    ...
    constructor(page: Page) {
        ...
        this.eventDateRangeHeader = page.locator("//span[text()='Event Date / Range']");
        ...
        this.groupsColumnData = page.locator("//table[@class='text-ui-fg-subtle txt-compact-small relative w-full']//td[3]");
        this.departmentColumnData = page.locator("//table[@class='text-ui-fg-subtle txt-compact-small relative w-full']//td[2]");
        ...
        this.deleteProgramConfirmation = page.locator("//div[@class='shadow-elevation-flyout bg-ui-bg-component flex w-fit min-w-[360px] max-w-[440px] gap-x-3 overflow-hidden rounded-lg p-3']");
    }
}